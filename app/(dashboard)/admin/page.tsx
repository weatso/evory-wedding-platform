                ...
                {staffUsers.length === 0 ? (
                    ...
                    <Card key={user.id} className="p-4 flex items-center justify-between shadow-sm border-slate-200 hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${user.role === 'ADMIN' ? 'bg-purple-100 text-purple-700' : user.role === 'PARTNER' ? 'bg-blue-100 text-blue-700' : 'bg-amber-100 text-amber-700'}`}>
                        ...
                        <span className={`px-2 py-1 rounded text-[10px] font-bold border ${user.role === 'ADMIN' ? "border-purple-200 text-purple-700 bg-purple-50" : user.role === 'PARTNER' ? "border-blue-200 text-blue-700 bg-blue-50" : "border-amber-200 text-amber-700 bg-amber-50"}`}>
                            {user.role}
                        </span>
                    </Card>
                ))}
