...
import { 
  ...
  MonitorPlay, FolderGit2, ArrowLeft
} from "lucide-react";
...
export default function AppSidebar({ systemRole, workspaceSlug }: AppSidebarProps) {
  ...
  // 3. MENU PROYEK (Level Acara - Hanya muncul jika masuk ke dalam proyek)
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        {/* NAVIGASI SCROLLABLE */}
        <nav className="flex-1 py-4 flex flex-col gap-6 overflow-y-auto overflow-x-hidden custom-scrollbar">
          ...
          {/* BLOK 2: MENU PROYEK AKTIF (Hanya muncul jika sedang di dalam rute Proyek) */}
          {projectSlug && (
            <div className="px-4 relative">
              ...
              {!isCollapsed && (
                <div className="flex flex-col mb-3 ml-2">
                  <p className="text-[9px] font-bold text-[#E5C185] uppercase tracking-[0.2em]">Acara Aktif</p>
