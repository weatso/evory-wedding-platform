      ...
      <div className="min-h-screen w-full relative bg-[#F1F1E8]" style={{ '--font-isi': '"FontIsiCustom", serif', '--font-judul': '"FontJudulCustom", serif', fontFamily: 'var(--font-isi)' } as React.CSSProperties}>
         ...
         <div className="relative z-10 w-full max-w-[420px] mx-auto md:mr-0 md:ml-auto min-h-screen shadow-2xl transition-all duration-500 overflow-hidden" style={{ backgroundColor: COLORS.paper, backgroundRepeat: 'repeat-y', backgroundSize: '100% auto', backgroundBlendMode: 'multiply' }}>
            ...
            <BaseSplash
               ...
               background={
                  <img src={`${ASSETS}/01-Cover/PENGANTIN.svg`} className="w-full h-full object-cover opacity-30" alt="Splash Background" />
               }
            />
            ...
            <BaseSectionWrapper id="lovestory" className="text-center py-20 px-6 bg-white md:ml-auto md:mr-0">
               <BaseLoveStory
                  ...
                  styles={{
                     ...
                     timelineContainer: "space-y-8 relative mt-10",
                     timelineLine: "absolute left-1/2 top-0 bottom-0 w-px bg-[#D7CCC8] -translate-x-1/2",
                     yearBadge: "bg-[#EFEBE9] p-2 rounded-full inline-block text-xs font-bold text-[#5D4037] mb-2 border border-[#D7CCC8]",
                     itemTitle: "font-bold text-[#5D4037]",
                     itemText: "text-xs text-gray-600 px-8 mt-1 leading-relaxed"
                  }}
               />
            </BaseSectionWrapper>
            ...
            <BaseSectionWrapper id="live" className="text-center py-16 px-6 md:ml-auto md:mr-0">
               <BaseLiveStream
                  ...
                  styles={{
                     title: "font-judul text-xl font-bold text-[#5D4037] mb-6",
                     videoContainer: "aspect-video w-full bg-black rounded-xl mb-6 relative overflow-hidden shadow-lg border-4 border-white"
                  }}
               />
            </BaseSectionWrapper>
